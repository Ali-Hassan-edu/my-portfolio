  ...
  return (
    <div className="card" onClick={onClick} style={{ cursor: "pointer", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "18px 20px 20px", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", lineHeight: 1.65, flex: 1, marginBottom: 16 }}>{truncate(post.description || post.content, 120)}</p>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 11, color: "rgba(255,255,255,0.25)" }}>
  ...
  return (
    <div style={{ minHeight: "100vh", paddingTop: 80 }}>
      <div className="container" style={{ maxWidth: 760, paddingTop: 48, paddingBottom: 80 }}>
        <button onClick={onBack} style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.4)", fontSize: 13, marginBottom: 32, display: "flex", alignItems: "center", gap: 6 }}>
          ← Back to Blog
        </button>
        ...
        <div style={{ display: "flex", gap: 20, fontSize: 12, color: "rgba(255,255,255,0.3)", marginBottom: 40 }}>
          <span>{formatDate(post.created_at)}</span>
          <span>{readingTime}</span>
        ...
        <div style={{ fontSize: 15, color: "rgba(255,255,255,0.65)", lineHeight: 1.85, whiteSpace: "pre-wrap" }}>
