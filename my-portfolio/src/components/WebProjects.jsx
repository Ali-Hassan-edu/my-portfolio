      ...
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <h2 className="section-title" style={{ fontFamily: "Syne, sans-serif", fontWeight: 800, letterSpacing: "-1.5px", fontSize: "clamp(32px,5vw,52px)", marginBottom: 20 }}>
            Web <span style={{ background: "linear-gradient(135deg,#4DFFB4,#38BDF8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Projects</span>
          </h2>
