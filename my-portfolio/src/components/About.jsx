        ...
        <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "start" }}>
          <div>
            ...
            <div className="about-info-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 28 }}>
              {[
                ...
                { l: "Status", v: info?.available ? "Open to Work ✦" : "Not Available" },
              ].map((item) => (
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { period: "2023 — Present", role: "B.S. Software Engineering", company: "COMSATS University, Vehari", desc: "Studying software engineering with focus on full-stack development, mobile applications, and AI.", accent: "#A78BFA" },
                { period: "2024 — Present", role: "Full Stack Developer", company: "Freelance · Remote", desc: "Building full-stack web & Android apps for clients worldwide.", accent: "#FF4D6D" },
                { period: "2023 — 2024", role: "AI & ML Developer", company: "Academic Projects", desc: "Developed AI/ML projects as part of coursework and personal interest.", accent: "#4DFFB4" },
              ].map((t, i) => (
